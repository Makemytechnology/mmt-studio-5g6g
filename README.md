...
<!--
  KEEP IN SYNC: This is the PUBLISHED umbrella README — publish-mono.sh
  copies it verbatim to the root of the public mirror
  (github.com/Makemytechnology/mmt-studio-5g6g). It is a SEPARATE,
  longer doc from the private repo's root README.md and is NOT
  auto-synced. If you change install/usage instructions here, mirror any
  shared guidance into the private root README.md too so the two don't
  drift.
-->
...
> **Note:** On a fresh Windows system, install
> [Git for Windows](https://git-scm.com/download/win) first — the
> `git clone` command below is provided by it and won't work until Git
