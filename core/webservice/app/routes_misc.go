...
func (s *Server) registerMiscRoutes() {
	...
	// nbiot/psm, cp-data, edrx, nidd, tags/readers/inventory routes
	// live in routes_iot.go (wired to the iot module — previously
	// emptyArrayRoute stubs that 404/405'd every IoT feature).
