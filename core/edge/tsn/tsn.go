...
// but does not itself define. GateSchedule rows here remain the
// GUI/tester view; the normative gate programming path is the TSN AF
// (nf/tsnaf) shipping TS 24.539 set-parameter PMICs to DS-TT/NW-TT.
//
// The Rel-19 control plane on top of these tables lives in nf/tsnaf
// (TSN AF: 5GS bridge registry, §5.27.5 bridge delay reporting toward
// the CNC, §5.28.2 stream configuration) and nf/tsctsf (TS 29.565
// time sync / TSC QoS exposure). The TS 24.539 PMIC/UMIC codec they
// share is at ./ttmgmt.
package tsn
