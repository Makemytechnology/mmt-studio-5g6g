...
func init() {
	...
	// Rel-19 TSC N2 leg — network-initiated PDU Session Resource Modify
	// carrying TSCTrafficCharacteristics for TSC flows added after
	// establishment (TS 23.502 §4.3.3 step 3; see pdumodify/tsc.go).
	session.NGAPModifyTSCByIMSI = pdumodify.SendTSCModify
}
