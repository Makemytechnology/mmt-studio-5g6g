...
var docMap = map[string][]string{
	...
	"TS 22.011": {"specs/3gpp/ts_122011v*p.pdf"}, // Service accessibility
	...
	"TS 23.247": {"specs/3gpp/ts_123247v*p.pdf"}, // MBS architecture
	"TS 23.271": {"specs/3gpp/ts_123271v*p.pdf"}, // LCS functional description
	...
	"TS 24.539": {"specs/3gpp/ts_124539v*p.pdf"}, // 5GS ↔ TSN translator (PMIC/UMIC) protocol
	...
	"TS 29.565": {"specs/3gpp/ts_129565v*p.pdf"}, // Ntsctsf services (TSCTSF)
	...
	"TS 28.552": {"specs/3gpp/ts_128552v*p.pdf"}, // MDA/KPI performance measurements (NR)
	"TS 28.554": {"specs/3gpp/ts_128554v*p.pdf"}, // 5G end-to-end KPIs
	"TS 29.122": {"specs/3gpp/ts_129122v*p.pdf"}, // T8 northbound APIs (SCEF/NEF)
	"TS 29.500": {"specs/3gpp/ts_129500v*p.pdf"}, // SBI technical realization
	"TS 29.520": {"specs/3gpp/ts_129520v*p.pdf"}, // Nnwdaf services
	"TS 32.290": {"specs/3gpp/ts_132290v*p.pdf"}, // CHF charging service (Nchf)
	"TS 32.291": {"specs/3gpp/ts_132291v*p.pdf"}, // CHF charging API (Nchf REST)
	"TS 32.422": {"specs/3gpp/ts_132422v*p.pdf"}, // Trace control and configuration
	"TS 32.423": {"specs/3gpp/ts_132423v*p.pdf"}, // Trace data definition
	"TS 33.117": {"specs/3gpp/ts_133117v*p.pdf"}, // Security assurance requirements (SCAS)
	"TS 33.127": {"specs/3gpp/ts_133127v*p.pdf"}, // Lawful interception architecture
	"TS 33.128": {"specs/3gpp/ts_133128v*p.pdf"}, // Lawful interception protocols (X1/X2/X3)
	...
	"RFC 2617": {"specs/ietf/rfc2617*.txt", "specs/ietf/rfc2617*.pdf"}, // HTTP Digest authentication
	"RFC 3264": {"specs/ietf/rfc3264*.txt", "specs/ietf/rfc3264*.pdf"}, // SDP offer/answer model
	"RFC 3515": {"specs/ietf/rfc3515*.txt", "specs/ietf/rfc3515*.pdf"}, // SIP REFER method
	"RFC 3840": {"specs/ietf/rfc3840*.txt", "specs/ietf/rfc3840*.pdf"}, // SIP UA capabilities (Contact feature tags)
	"RFC 4594": {"specs/ietf/rfc4594*.txt", "specs/ietf/rfc4594*.pdf"}, // DiffServ service classes
	"RFC 7951": {"specs/ietf/rfc7951*.txt", "specs/ietf/rfc7951*.pdf"}, // JSON encoding of YANG data
	"RFC 8040": {"specs/ietf/rfc8040*.txt", "specs/ietf/rfc8040*.pdf"}, // RESTCONF protocol
	"RFC 9633": {"specs/ietf/rfc9633*.txt", "specs/ietf/rfc9633*.pdf"}, // DetNet YANG model
