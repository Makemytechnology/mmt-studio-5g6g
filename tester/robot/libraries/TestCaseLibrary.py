...
class TestCaseLibrary:
    ...
    @keyword("Run Test")
    def run_test(self, tc_id, **params):
        """Alias for `Run Python TestCase` — the positioning / IoT / NTN
        suites were authored against this shorter name."""
        return self.run_python_testcase(tc_id, **params)
